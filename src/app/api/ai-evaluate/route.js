...
- หากนักเรียนมีสิ่งที่ไม่อิน/ไม่ชอบ (เช่น ไม่ชอบเลือด, ไม่ชอบการท่องจำหนักๆ, ไม่ชอบคำนวณซ้ำซาก ฯลฯ) ให้ระวังอย่าปรับเพิ่มค่าน้ำหนักหรือเชียร์สาขาที่มีกิจกรรมเหล่านั้นเป็นหลัก!
- หากนักเรียนมีสิ่งชอบ/ความสนใจเด่นชัด (เช่น ชอบ AI, เขียนโปรแกรม, การวางแผน, ศิลปะ ฯลฯ) ให้ช่วยส่งเสริมและปรับค่าน้ำหนักมิติทักษะที่เกี่ยวข้องให้สะท้อนตัวตนจริงของนักเรียน!
