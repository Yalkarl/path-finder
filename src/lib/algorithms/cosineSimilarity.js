...
export const PATH_PREFERENCE_KEYWORDS = {
  ...
  'computer-science': {
    likes: ['คอมพิวเตอร์', 'วิทยาการคอมพิวเตอร์', 'เทคโนโลยี', 'เทคโนโลยีดิจิทัล', 'เขียนโปรแกรม', 'โค้ด', 'โค้ดดิ้ง', 'ซอฟต์แวร์', 'พัฒนาแอป', 'เว็บบล็อก', 'ai', 'ปัญญาประดิษฐ์', 'ไอที', 'ฐานข้อมูล', 'ไซเบอร์', 'เกม', 'esports', 'หุ่นยนต์', 'อัลกอริทึม', 'ระบบสารสนเทศ', 'คลาวด์', 'dev', 'developer', 'ศิลปะดิจิทัล', 'การออกแบบ UI/UX', 'กราฟิกคอมพิวเตอร์', 'แอนิเมชัน', 'สื่อมัลติมีเดีย', 'การออกแบบเกม', 'ออกแบบเว็บ'],
    dislikes: ['คิดคำนวณ', 'คำนวณคณิต', 'คำนวณ']
  },
  'psychology': {
