...
export const PATH_PREFERENCE_KEYWORDS = {
  ...
  'medicine': {
    ...
    dislikes: ['กลัวเลือด', 'เลือด', 'กลัวศพ', 'ศพ', 'บาดแผล']
  },
  'dentistry': {
  ...
  'music-performing-arts': {
    likes: ['ดนตรี', 'ดุริยางคศิลป์', 'ดุริยางศาสตร์', 'เล่นดนตรี', 'แต่งเพลง', 'เครื่องดนตรี', 'เปียโน', 'กีตาร์', 'การขับร้อง', 'ดนตรีคลาสสิก', 'วงดนตรี', 'โปรดิวเซอร์เพลง'],
    dislikes: []
  },
